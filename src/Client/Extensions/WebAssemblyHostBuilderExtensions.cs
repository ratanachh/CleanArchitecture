...
using Inventory.Client.Infrastructure.Authentication;
using Inventory.Client.Infrastructure.Managers;
...
using Inventory.Client.Infrastructure.Managers.ExtendedAttribute;
...
namespace Inventory.Client.Extensions
{
    ...
    {
        private const string ClientName = "Inventory.API";
        ...
        public static WebAssemblyHostBuilder AddClientServices(this WebAssemblyHostBuilder builder)
        {
            builder
                ...
                .AddScoped<InventoryStateProvider>()
                .AddScoped<AuthenticationStateProvider, InventoryStateProvider>()
                .AddManagers()
