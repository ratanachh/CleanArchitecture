...
using Inventory.Application.Features.ExtendedAttributes.Commands.Delete;
...
using Inventory.Application.Features.ExtendedAttributes.Queries.GetById;
using Inventory.Domain.Contracts;
using Microsoft.AspNetCore.Mvc;

namespace Inventory.Server.Controllers.Utilities.ExtendedAttributes.Base
{
    /// <summary>
