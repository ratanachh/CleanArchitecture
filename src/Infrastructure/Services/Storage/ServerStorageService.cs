...
using Inventory.Application.Interfaces.Services.Storage;
using Inventory.Application.Interfaces.Services.Storage.Provider;
using Inventory.Application.Interfaces.Serialization.Serializers;

namespace Inventory.Infrastructure.Services.Storage
{
